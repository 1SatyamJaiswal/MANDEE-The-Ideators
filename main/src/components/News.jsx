        ...
        <Stack direction="row" justifyContent="space-evenly" alignItems="center">
            <div className="newsBox">
                <Card sx={{ maxWidth: 400 }}>
                    ...
                    />
                    <CardContent>
                        <Typography gutterBottom style={{color: "#50734F",fontFamily: "Poppins"}} variant="h5" component="div">
                        ...
                        <Typography variant="body2" color="text.secondary">
                            ...
                            Ayushi Sikarwar Published on 18 January, 2023 5:49 PM IST
                        </Typography>
                    </CardContent>
                    <CardActions>
                        <a href="https://krishijagran.com/news/new-agriculture-policy-in-punjab-by-march-31-kuldeep-singh-dhaliwal/" type ="button" className='newsLink'>Learn More</a>
                    </CardActions>
                </Card>
            </div>
            <div className='newsBox'>
                <Card sx={{ maxWidth: 400 }}>
                    ...
                    />
                    <CardContent>
                        <Typography gutterBottom variant="h5" style={{color: "#50734F",fontFamily: "Poppins"}} component="div">
                    ...
                    <CardActions>
                        <a href="https://krishijagran.com/news/fertilizer-ministry-requests-additional-rs-30-000-crore-fertiliser-subsidy-for-final-quarter/" type="button" className='newsLink'>Learn More</a>
                    </CardActions>
                </Card>
            </div>
            <div className='newsBox'>
                <Card sx={{ maxWidth: 400 }}>
                    ...
                    <CardActions>
                        <a href="https://krishijagran.com/news/govt-plans-to-market-organic-farm-products-under-one-roof-through-cooperatives/" type="button" className='newsLink'>Learn More</a>
                    </CardActions>
                </Card>
            </div>
        </Stack>
